...
def _load_tm_handler(*, state: TopicModelContainer, model_info: tm.ModelFolder, slim: bool = False, n_tokens: int = 500):
    ...
    topics = inferred_topics.get_topics_overview_with_score(n_tokens=n_tokens)
