...
# from penelope.utility.filename_utils import replace_folder_and_extension
# from penelope.utility import zipfile_or_filename
...
# class LoaderRegistry(registry.Registry[PayloadLoader]):
#     pass


# @LoaderRegistry.register(key="csv")
...
# @LoaderRegistry.register(key="feather")
